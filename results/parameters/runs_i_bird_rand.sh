...
#SBATCH --gres=gpu:1
#SBATCH --job-name=i_bird_rand_param 
#SBATCH --mem=3GB
...
ANN_CONF_LEARN="--beta_start_learn $beta_start_learn --gamma1_init_param $gamma1_init_param --gamma2_init_param $gamma2_init_param --rand_split_nodes"
