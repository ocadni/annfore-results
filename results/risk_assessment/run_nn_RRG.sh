...
path_dir="$(pwd)/ann/${type_graph}_${nsrc}src/3lpow1/"
...
#init_name="10kst10ks_${n_test_rnd}rnd_6lexp_"
init_name="10kst10ks_lastobs_psus07_psrc2_"
...
do
    ...
    python $SCRIPT $GEN_GRAPH --seed $seed $EXTRA_FLAGS $SPARSE_OBS $TRAINING --start_conf $st_conf --num_conf $n_conf --num_threads 16 $EXPER
done